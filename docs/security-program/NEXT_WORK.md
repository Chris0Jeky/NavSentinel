...
warning arm, a quiet benign OTP control, and a mixed control. Its typed sink and
pre-launch egress fence are browser-only test infrastructure. It does not alter
runtime behavior, satisfy native/OS coverage, or turn a warning into a block.
