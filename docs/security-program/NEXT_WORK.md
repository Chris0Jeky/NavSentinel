...
2. **Keep PR #572 parked at AI-31.** The automated repair and status records are complete, and the manual exact-head Chrome procedure is prepared. Keep the known MEDIUM false intervention for same-task and deferred page popups and the pointerup/mouseup holdout explicit; do not widen opener authority to erase either limitation.
