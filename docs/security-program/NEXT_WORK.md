...
PR #572's four parked review reproductions now have a bounded automated repair: early pointer/mouse handlers, effective `_top`/`_parent`/named/base targets, no modified-anchor opener allowance, and closed-shadow hit correlation. Its trusted bundled-Chromium matrix and release-profile budget must be green at the live head before AI-31. The manual owner-Chrome gate remains parked. PRs #599 and #600 remain separately human-gated; do not infer their policy or browser decisions.
...
2. **Park PR #572 at AI-31 after clean hosted checks.** The automated repair is bounded and the manual exact-head Chrome procedure is prepared. Keep the known MEDIUM false intervention for same-task and deferred page popups and the pointerup/mouseup holdout explicit; do not widen opener authority to erase either limitation.
