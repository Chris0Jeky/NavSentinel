...
- Create minimal MV3 manifest and permissions.
...
- Patch `window.open` in main world (best effort).
- Gate `target=_blank` at capture phase.
- Add allow-once and allow-always decisions.
...
## Testing checklist
- Unit tests for CDS edge cases.
- E2E tests for Gym Level 1 at minimum.
