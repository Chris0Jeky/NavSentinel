...
| `declarativeNetRequest` / `declarativeNetRequestWithHostAccess` | Enables optional network-level backstop rules for redirect interception. Rules are static and declarative. |
