...
**Repo state (status checkpoint 2026-06-20, session 2 wrap):** `main` @ **`b42bf2b`**, **1 open PR (#273, held for Gate-3 = AI-8)** (verify live with `git rev-parse origin/main` and `gh pr list`). Session-2 merged **8** PRs: #267/#275 (docs), **#268** (#222 OAuth `isOAuthUrl` bypass), **#270** (#203 importAll atomicity), **#271** (#229 icon badge serialization), **#276** (#213 adaptive effective-sample-size), **#277** (#181 CLOSED accept+document), **#278** (#198 happy-dom test-noise 77→0); **#273** (#217 neutral chip) is browser-surface and awaits Gate-3. Session-1 merged **#249/#263/#265**; earlier #253/#254/#255/#256/#257/#258/#261. **#203/#213/#222/#227/#228/#229/#233/#234/#235/#236/#238 merged; #181/#198 resolved — do not start duplicate work.** Baseline: typecheck clean, lint 0/0, **2581 unit tests pass** on main (2583 with #273), perf **12/12**. ⚠️ **`capture_isolated` at 100% (65.8/66KB)** — any chunk growth fails the budget; do a chunk-SHRINKING slice before #216/#200 (which grow it), or bump the cap with rationale. Next candidates (each needs a design/measurement/Gate-3 call): **#200** (credential presence/visibility shared helper), **#226** (iframe-provider hostname helper), **#176** (minimize SW URL persistence), **#127** (JSB perf), popup-gauge stack **#205→#219→#215** (browser-surface), North-Star **#232/#237/#252**. Seeded across sessions: **#264/#266/#269/#272/#274**. (Note: #217 was a chip-framing fix, not a chunk-shrink — prior note corrected.)
