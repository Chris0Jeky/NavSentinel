...
| #356 | Refreshed/pushed and thread-clean; pre-guide `1accb43` Build/Unit + E2E green; current guide prepared and usable only after its live exact-head CI precheck, then human Gate-3 |
...
| RI-03 | P0 beta blocker | Re-green the current #356 guide head, then complete human Gate-3; recreate or defer #273 | Agent then Chris | #273/#356; #399 stays deferred | Guide's live precheck points only to a green exact head; #356 has human Gate-3 evidence; #399 remains outside beta blockers until its measurement methodology is ready |
...
- #356: P0 guide prepared, current exact-head CI plus human Gate-3 pending; #273
  recreate/defer; #399 is closed and
