...
| Release profile | **PR #509 ready; Gate-3 pending** | AI-9 selected interaction-only. Default runtime/manifest/package omit reputation; deterministic `research-reputation` is unpacked-only and non-release |
