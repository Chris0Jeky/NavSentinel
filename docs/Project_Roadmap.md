...
| 4 | Differentiate | 8 | 6 | In progress (P4-01 visual sim partially done, P4-02 JS behavior partially done, P4-03–P4-04 pending, P4-05–P4-08 done) |

Total: **47 tasks** across 5 phases. **45/47 complete** (remaining: P4-03 Firefox port, P4-04 community intelligence; P4-01 and P4-02 have foundational PRs merged but need completion).
...
| P4-02 | JavaScript behavior analysis | XL | in progress | P3 gate (cleared) | PRs #98 (design), #101-#105 (slices 2-4), #107 (NRS), #108 (gym) merged; stale TODOs cleaned |
