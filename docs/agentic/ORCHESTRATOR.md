...
**Codex pickup status (verified 2026-06-14):** `main` @ **`a68958c`** after #251 (`gym:serve` Vite-8 fix). Open PRs: **#249** (P5-C1 / #238, human Gate-3), **#253** (P5-B1 / #236, review fixes pushed through `42fff89`, CI green/re-review running), **#254** (draft Codex contract/status refresh, CI green before latest status sync), **#255** (P5-A2 / #233 Smart Mode blank-prompt suppression, keyboard/Live OAuth suppressor/OAuth monitor parity fixes pushed through `4a77b39`, CI/re-review running).
...
| P5-A2 / #233 Smart Mode blank-prompt suppression | `feat/p5a2-signal-smart-gating` | `origin/main` | `../NavSentinel-p5a2-smart-gating` | #255 | local security review done | local runtime review done | pending after `4a77b39` | Gemini keyboard-activation and Codex Live OAuth/OAuth-tracker feedback fixed; local verification: typecheck, lint, build, focused OAuth/Smart/SW tests 197 pass, targeted E2E 3 pass, perf budget 12/12, full unit 2443 pass |
