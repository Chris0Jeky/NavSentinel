...
- **Verification counts:** PR #180's D-PROF branch verified **2211** Vitest tests; current `fix/prompt-outcome-race` D-STORE branch verifies typecheck clean, lint 0/0, build clean, targeted storage **41 passed**, and full Vitest **2218 passed**.
