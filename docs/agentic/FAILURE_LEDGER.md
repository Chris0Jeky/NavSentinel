...
| 2026-07-03 | non_blocking_risk | GitHub PR / issue auto-close | The phrase "Does **not** close #418" in PR #433's body matched "close #418" — GitHub's closing-keyword parser ignores negation — and auto-closed #418 on merge, despite the PR intending it to stay open as a gated residual tracker. | Reopened #418 with a comment explaining the accidental auto-close and its remaining gated (Safe-Browsing comparison arm) scope. | Never put a closing keyword (close/closes/fix/fixes/resolve/resolves) adjacent to an issue number in a PR body/commit unless the merge should close it, even when negated. Use "remains open"/"advances #N". Persisted to memory `github-close-keyword-negation`. | resolved |
