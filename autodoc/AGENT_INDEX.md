...
| Main-world guard and bridge | `main_guard.ts`, `pushstate_guard.ts`, `dblclick_guard.ts` | `clickfix_detector.ts`, `mutation_monitor.ts`, `oauth_monitor.ts` | `npm run build`, `bridge-outbound.test.ts`, `bridge-clipboard-pressure.spec.ts`, phase2-detections E2E, pushstate/dblclick/clickfix unit tests. |
