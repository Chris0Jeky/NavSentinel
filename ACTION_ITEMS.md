...
- **North-Star initiative (2026-06-13):** the research + audit initiative completed this session (main has since advanced to `da400fb`; discovery cycles 3–4 added issues up to #231). Internal audit = **153 verified findings**; 3 deep-research passes done. All artifacts persisted under **`docs/research/NORTHSTAR_*`**, and the program plan is **`docs/NORTHSTAR_ROADMAP.md`** (Phase 5: FP-Elimination / Friend-Advisor / Feedback-Capture / Architecture). **Top unblockers:** signal-level Smart-Mode gating, enrich the capture record, top-sites trust-tier prior. GitHub-issue filing for the ~15 new P5 slices is **awaiting Chris's go-ahead** (outward-facing). One unfilled research gap (GAP D: conformal/rrweb/single-user loop) to re-run before building P5-C5.

---

## Action items

**OPEN: AI-5 (deferred pending visual-sim tech call).** AI-1, AI-2 resolved 2026-06-05; **AI-3, AI-4 resolved 2026-06-13** (see Completed log). The deferred manual checks now live in `docs/agentic/POST_MERGE_MANUAL_VERIFICATION.md`.
