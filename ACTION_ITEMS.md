...
**Last updated:** 2026-06-14 (Codex durable live-state checkpoint) · exact `main` SHA is intentionally not hardcoded here; verify with `git rev-parse origin/main`. Merged status includes **#254**, **#256**, **#257**, **#258**, and later docs-cleanup PRs. Open PRs: **#249** latest `3e0389e`, green/clean but still blocked on **AI-6** manual Gate-3. **AI-5 open (reference brand logos)** · **AI-6 open (Gate-3 #249)**.
