...
**Last updated:** 2026-06-14 (Codex checkpoint) · `main` @ `db63192` after merging **#253** / P5-B1. Open PRs: **#249** latest `47e4fb9`, green/clean but still blocked on **AI-6** manual Gate-3; **#254** draft docs/CI refresh; **#256** latest `1890ef0`, review threads resolved, Build/Unit green and E2E running. **AI-5 open (reference brand logos)** · **AI-6 open (Gate-3 #249)**.
