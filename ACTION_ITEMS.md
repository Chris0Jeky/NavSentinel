...
- **(2026-06-14 Codex pickup - P5-A2 update):** New PR **#255** opened for P5-A2 / #233 (`feat/p5a2-signal-smart-gating`, commit `e28c3bf`). Scope: Smart-Mode blank-anchor prompt suppression for narrow benign contexts with trusted pointer/click gating, NRS block/factor safeguards, curated IdP/payment matching, and new Gym/E2E regression. Local verification: `typecheck`, `lint`, `build`, focused unit (15 pass), targeted E2E (2 pass), perf budget 12/12 (`capture_isolated` 62.5KB / 63KB), full unit 2441 pass with known happy-dom/network stderr. Two independent local adversarial reviews completed; all findings addressed. CI/review now running on #255. Human-owned OPEN items remain **AI-5** and **AI-6**.
