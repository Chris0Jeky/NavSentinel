...
**Last updated:** 2026-06-14 (Codex post-merge checkpoint) · `main` @ `213ebcb` after merging **#254**, **#256**, and **#257**. Open PRs: **#249** latest `3e0389e`, green/clean but still blocked on **AI-6** manual Gate-3. **AI-5 open (reference brand logos)** · **AI-6 open (Gate-3 #249)**.
