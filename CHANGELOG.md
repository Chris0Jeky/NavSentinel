...
- **Protection Center reasons.** Real stored events, including credential reason codes and blocked new-tab prompts, now show readable reasons instead of raw codes (#878).
